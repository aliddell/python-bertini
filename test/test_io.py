...
# TODO: there's a problem when running both of these tests which causes the BertiniInput in test2
# to share its variable group with that of test1. I have no idea why.
